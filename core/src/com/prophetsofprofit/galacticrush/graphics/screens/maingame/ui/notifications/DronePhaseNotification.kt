 ...
 */
class DronePhaseNotification(width: Float, height: Float) : Notification(width, height, TextureRegionDrawable(TextureRegion(Texture("image/placeholder.png"))), "The drones are acting", Scene2DSkin.defaultSkin) {
