...
class MainMenuScreen(main: Main) : GalacticRushScreen(main) {
    ...
    init {
         ...
         * OPTIONS BUTTON
         */
        val optionsButton = TextButton("Options", Scene2DSkin.defaultSkin, "main-menu")
         ...
         * JOIN GAME BUTTON
         */
        val joinGameButton = TextButton("Join Game", Scene2DSkin.defaultSkin, "main-menu")
         ...
         * HOST GAME BUTTON
         */
        val hostGameButton = TextButton("Host Game", Scene2DSkin.defaultSkin, "main-menu")
         ...
         * DEMO BUTTON
         */
        val demoButton = TextButton("TEST", Scene2DSkin.defaultSkin, "main-menu")
