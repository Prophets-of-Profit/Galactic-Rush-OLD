 ...
 */
enum class PlanetAttribute(val displayString: String, val stringValue: (Double) -> String) {
    ...
    TEMPERATURE("Temperature", { "%.4f".format(50 + it * 700) + " K" }),
    ATMOSPHERE("Pressure", { "%.4f".format(10.0.pow(2 * it)) + " atm" }),
